            ...
            <asp:CreateUserWizardStep runat="server" ID="RegisterUserWizardStep">
                <ContentTemplate>
                    <p class="message-info">
                        Mật khẩu được yêu cầu phải có tối thiểu <%: Membership.MinRequiredPasswordLength %> độ dài ký tự.
                    </p>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="Email"
                                    CssClass="field-validation-error" ErrorMessage="địa chỉ Email là bắt buộc." />
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmPassword"
                                     CssClass="field-validation-error" Display="Dynamic" ErrorMessage="Xác nhận mật khẩu là bắt buộc." />
                                <asp:CompareValidator runat="server" ControlToCompare="Password" ControlToValidate="ConfirmPassword"
                                     CssClass="field-validation-error" Display="Dynamic" ErrorMessage="Mật khẩu và các yêu cầu không phù hợp." />
                            </li>
                        </ol>
